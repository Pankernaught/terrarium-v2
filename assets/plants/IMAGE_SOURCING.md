...
| `sphagnum-palustre` | *Sphagnum palustre* | Sphagnum Moss | `plants/sphagnum-palustre.png` | Pending |
| `vesicularia-ferriei` | *Vesicularia ferriei* | Weeping Moss | `plants/vesicularia-ferriei.png` | Pending |
...
| `cissus-amazonicus` | *Cissus amazonica* | Amazon Jungle Vine | `plants/cissus-amazonicus.png` | Pending |
